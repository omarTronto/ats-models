...
def get_samsa_sentence_scores(
    ...
    sys_sents = [utils_prep.normalize(output, lowercase, tokenizer, tokenizer_obj=tokenizer_obj) for output in sys_sents]
...
def corpus_samsa(
    ...
    return np.mean(get_samsa_sentence_scores(orig_sents, sys_sents, lowercase, tokenizer, verbose, tokenizer_obj))
...
def sentence_samsa(
    ...
    return get_samsa_sentence_scores([orig_sent], [sys_sent], lowercase, tokenizer, verbose, tokenizer_obj)[0]
