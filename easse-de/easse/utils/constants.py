...
VALID_METRICS = [
    ...
    'fre_sent',
    'fre_corpus',
    'wiener_sachtextformel_1_sent',
    'wiener_sachtextformel_2_sent',
    'wiener_sachtextformel_3_sent',
    'wiener_sachtextformel_4_sent',
    'wiener_sachtextformel_1_corpus',
    'wiener_sachtextformel_2_corpus',
    'wiener_sachtextformel_3_corpus',
    'wiener_sachtextformel_4_corpus',
]
DEFAULT_METRICS = ['bleu', 'sari', 'fkgl', 'fre_corpus', 'wiener_sachtextformel_1_corpus']

LANGUAGE = "de"
SPACY_MODEL_NAME = "_core_news_sm"