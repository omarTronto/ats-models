...
def corpus_quality_estimation(
    ...
    orig_sentences = [normalize(sent, lowercase, tokenizer, tokenizer_obj=tokenizer_obj) for sent in orig_sentences]
    sys_sentences = [normalize(sent, lowercase, tokenizer, tokenizer_obj=tokenizer_obj) for sent in sys_sentences]
    return {
