...
def corpus_fkgl(sentences: List[str], tokenizer: str = "13a", lowercase: bool = False, tokenizer_obj=None):
    scorer = FKGLScorer()
    for sentence in sentences:
        scorer.add(normalize(sentence, tokenizer=tokenizer, lowercase=lowercase, tokenizer_obj=tokenizer_obj))
    return scorer.score()
